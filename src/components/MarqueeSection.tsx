...
const MarqueeSection = () => {
    ...
    return (
        <div className="relative py-10 overflow-hidden bg-[#070e0a]">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#070e0a] to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#070e0a] to-transparent z-10 pointer-events-none" />
